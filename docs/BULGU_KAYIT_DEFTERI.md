...
| Düşük-Mach rejiminde yakınsama HIZI: giriş BC onarıldı (parti 26) ama MUSCL sınırlayıcı gevelemesi 60×12'de 4596→23893 iterasyon fark yaratıyor; 120×24'te plato-dondurma tetiklenince 8002'ye iniyor — hızın kilidi sınırlayıcı dondurma politikası + akustik/taşınım ölçek ayrışması | Viskoz kulvarın satır-örtük gevşetmesi / düşük-Mach ön-koşullaması doğru adres (cfd-viskoz-tasarimi.md §4.2); S9 ölçümleri raporda | bu defter; parti 26 S9 raporu §10 |
