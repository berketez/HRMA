...
| Cidar inceltme politikası eksenel+radyali BİRLİKTE katlıyor; radyal kalem Gauss-maks yüzey ekstrapolasyonuyla tur başına yarılanarak yakınsamayı geciktiriyor (parti 24 ölçümü: sıvıda kalan %2,37 = eksenel %1,1 + radyal %1,3) | Parti 24'te bütçe/tur açılarak hüküm yeşile indi (65536 eleman, 5,3 sn); kalıcı iyileştirme (radyal katlamayı ayrıştıran politika) `structural_axisym.solve_with_refinement` kalemi olarak açık | bu defter; `hrma/app.py` FEA_MAX_ELEMS yorumu |
