...
{\large Sürüm 2.6.25 \quad|\quad Temmuz 2026}\\[6pt]
...
\begin{itemize}[leftmargin=1.4em]
  \item \textbf{Windows 10/11:} \texttt{HRMA-Setup-2.6.25.exe} dosyasını
  ...
  \item \textbf{macOS 11+ (Apple Silicon):} \texttt{HRMA-Setup-2.6.25-macOS.dmg}
...
\begin{notkutu}
\small\color{hrmadark}
\textbf{Sürüm 2.6.25 ile gelenler.} Bu sürüm üç görünür değişiklik
getiriyor. (1) Hibrit sayfasındaki \emph{Soğutma Kanalları} seçimi artık
gerçekten hesaba giriyor; önceki sürümlerde seçim yapılsa da termal analiz her
zaman soğutmasız çalışıyordu. Kanal seçtiğinizde çıkan uyarı, soğutucu film
katsayısının literatürden alındığını ve soğutucu debisinin doğrulanmadığını
belirtir --- bu bilinçli bir sınırdır, hata değildir. Aynı şekilde yanma odası
malzemesi ve cidar kalınlığı seçimleriniz de artık termal sonuçları
değiştirir. (2) Motorların ürettiği uyarılar artık arayüz dilinde okunur
metin olarak görünür; daha önce bir kısmı ham kod olarak düşüyordu.
(3) Güncelleme penceresi sürüm notlarını arayüz dilinizde gösterir.
...
HRMA v2.6.25 — Roket Motoru Analiz Paketi\\
