...
{\large Version 2.6.1 \quad|\quad July 2026}\\[6pt]
...
\begin{itemize}[leftmargin=1.4em]
  \item \textbf{Windows 10/11:} Download \texttt{HRMA-Setup-2.6.1.exe},
  ...
  \texttt{HRMA-Setup-2.6.1-macOS.dmg} and drag \texttt{HRMA} into
...
\begin{notebox}
\small\color{hrmadark}
\textbf{Version 2.6.1 note.} On macOS the update install can take a few
...
HRMA v2.6.1 — Rocket Motor Analysis Suite\\
