    ...
    def calculate_performance(self):
        ...
        return {
            ...
            'nozzle_angles': {
                ...
                'divergent_half_angle_deg': 12.0,  # bell nozzle optimized (conical ~15)
                'nozzle_type': 'bell',  # liquid motorlar genelde bell (Rao) nozzle
                ...
                'contraction_ratio': (cooling['chamber_diameter'] / (nozzle_geom['throat_diameter'] * 1000)) ** 2,
                'expansion_ratio': nozzle_geom['expansion_ratio'],
                'exit_pressure_bar': nozzle_geom['exit_pressure'],
                'bell_efficiency': 0.985,  # Rao bell vs conical
            },
            ...
            'design_summary': {
                ...
                'recommendation': (
                    f'Bu parametrelerle optimize edilmis sivi motor tasarimi. '
                    f'T/W={thrust_to_weight:.1f}, Isp(vac)={actual_isp_vac:.0f}s, '
                    f'c*={self.c_star:.0f} m/s. '
                    f'{self.cooling_type.capitalize()} sogutma, {self.injector_type} injector.'
                ),
            },
        }
