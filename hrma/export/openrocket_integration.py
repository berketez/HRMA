...
THRUST_SOURCE_LABELS = {
    ...
    'thrust_curve': 'solid grain burn-back solver (time-resolved)',
...
class OpenRocketExporter:
    ...
    def _create_eng_file(self, designation: str, diameter: float, length: float,
        ...
        lines.append(f"; thrust curve: "
                     f"{THRUST_SOURCE_LABELS.get(thrust_source, thrust_source)}")
        ...
        loaded_mass = prop_mass + (inert_mass or 0.0)
...
<openrocket version="1.5" creator="UZAYTEK">
    ...
    def generate_flight_profile(self, motor_data: Dict, rocket_params: Dict = None) -> Dict:
        ...
        prop_mass = _finite_positive(motor_data.get('propellant_mass_total')) or 0.0
