...
# Çıktı dosyaları (doğrulama grafiği/JSON) depo köküne yazılır — mutlak
# geliştirici yolu KULLANILMAZ, testler her makinede ve CI'da çalışır.
...
class SolidRocketValidationTest:
    ...
    def generate_validation_plots(self):
        ...
        try:
            ...
            plt.tight_layout()
            plt.savefig(str(_REPO_ROOT / 'validation_results.png'),
                       dpi=300, bbox_inches='tight')
            print(f"\nValidation plots saved to: {_REPO_ROOT / 'validation_results.png'}")
    ...
    def save_results_to_json(self):
        ...
        output_file = str(_REPO_ROOT / 'validation_results.json')
